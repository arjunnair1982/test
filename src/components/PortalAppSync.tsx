        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div>
            ...
            <div className="mt-8 space-y-4">
              {[
                { label: "Portal", desc: "Consultant assigns tasks and requests documents", color: "bg-turquoise" },
                { label: "Sync", desc: "Real-time synchronization across platforms", color: "bg-yellow" },
                { label: "MyAlva", desc: "Student receives tasks and uploads documents", color: "bg-white" }
              ].map((item, i) => (
          ...
          <div className="flex justify-center">
            <div className="relative">
              ...
              <div className="flex justify-center -my-3 relative z-10">
                <div className="bg-yellow rounded-full w-10 h-10 flex items-center justify-center shadow-lg">
